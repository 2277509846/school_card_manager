...
<body>
<form action="${pageContext.request.contextPath}/CashierController/shoppingList.do" method="get">
    <table>
        <tr>
            <th>学生学号</th>
            <th>商品id</th>
        ...
        <tr>
            <td colspan="2">
                <a href="${pageContext.request.contextPath}/CashierController/shoppingList.do?page=${page - 1}&condition=${condition}">上一页</a>
            </td>
            <td colspan="2">
                <label>
            ...
            <td colspan="2">
                <a href="${pageContext.request.contextPath}/CashierController/shoppingList.do?page=${page + 1}&condition=${condition}">下一页</a>
            </td>
        </tr>
        </tfoot>
    </table>
